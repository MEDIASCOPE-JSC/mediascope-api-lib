...
1. Добавление функции преобразования вида условия времени
...
1. Исправление отображения вывода оригинальных полей для атрибутов оригиналов

## [1.6.0] - 2025-10-16
Новый справочник и метод в TV Index API 

1. Добавление справочника баинговых аудиторий телекомпаний
2. Добавление метода получения количества активных задач пользователя

## [1.4.0] - 2025-09-11

1. Добавление отчета пересечения аудитории интернет-ресурсов с другими медиаобъектами consumption-media в Crossweb API
2. Исправлено описание метода wait_task
